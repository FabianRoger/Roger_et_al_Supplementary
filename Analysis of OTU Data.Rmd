...
ID$Lake <- factor(ID$Lake, levels = c("Botan", "Delsjön", "Lerum", "Surtesjön"), labels = c("Lake 1", "Lake 2", "Lake 3", "Lake 4"))
...
panel.cor <- function(x, y, digits = 2, prefix = "", cex.cor, ...)
{
    ...
    par(usr = c(0, 1, 0, 1))
    r <- abs(cor(x, y, use = "pairwise.complete.obs", method = "pearson"))^2
...
HeatMap_1p + 
  ...
  ggtitle("heatmap of abundant OTUs")+
