...
__this script exports:__
  ...
  figures:
  + figures/Fig_S_4.pdf           #growth curves
...
Bac$Lake[ Bac$BOT %in% b[ 1:12] ]  <-  "Lake 4"
Bac$Lake[ Bac$BOT %in% b[ 13:24]]  <-  "Lake 2"
Bac$Lake[ Bac$BOT %in% b[ 25:36]]  <-  "Lake 3"
Bac$Lake[ Bac$BOT %in% b[ 37:48]]  <-  "Lake 1"
...
```{r, echo=FALSE}
Bac[Bac$BOT == "22" & Bac$Lake == "Lake 2" & Bac$DIL == "09" & Bac$DAT == as.POSIXct("2012-07-06", tz = "GMT"),
    c("DAT", "Lake", "DIL", "G1", "G2", "BeadC")]

Bac[ Bac$BOT == "22" & Bac$Lake == "Lake 2" & Bac$DIL == "09" & Bac$DAT == as.POSIXct("2012-07-06", tz = "GMT"), c("G1","G2")] <- NA
```
...
ggplot( Bac[Bac$Lake == "Lake 1" , ],  aes( x = DAT, y = Cells, group = 1)) +
  labs(x = "date", y = "Cells/ml") +  
  facet_wrap( ~DIL)+
  geom_point( size = 1.2, colour = "orange", shape = 3 ) +
  geom_line( size = 0.5, colour = "orange") +
  geom_vline( xintercept = SamplDat, colour = "darkgrey", linetype = "dashed")+
  labs( title = "Lake 1", x = "date")+
  scale_y_continuous(limits=c(0, max(Bac$Cells, na.rm = T)))+
  theme_bw( )+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

ggplot( Bac[Bac$Lake == "Lake 2" , ],  aes( x = DAT, y = Cells, group = 1)) +
  labs(x = "date", y = "Cells/ml") +  
  facet_wrap( ~DIL)+
  geom_point( size = 1.2, colour = "darkred", shape = 17) +
  geom_line( size = 0.5, colour = "darkred") +
  geom_vline( xintercept = SamplDat, colour = "darkgrey", linetype = "dashed")+
  labs( title = "Lake 2", x= "date")+
  scale_y_continuous(limits=c(0, max(Bac$Cells, na.rm = T)))+
  theme_bw( )+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

ggplot( Bac[Bac$Lake == "Lake 3" , ],  aes( x = DAT, y = Cells, group = 1)) +
  labs(x = "date", y = "Cells/ml") +  
  facet_wrap( ~DIL)+
  geom_point( size = 1.2, colour = "darkgreen", shape = 15 ) +
  geom_line( size = 0.5, colour = "darkgreen") +
  geom_vline( xintercept = SamplDat, colour = "darkgrey", linetype = "dashed")+
  labs( title = "Lake 3", x = "date")+
  scale_y_continuous(limits=c(0, max(Bac$Cells, na.rm = T)))+
  theme_bw( )+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

ggplot( Bac[Bac$Lake == "Lake 4" , ],  aes( x = DAT, y = Cells, group = 1)) +
  labs(x = "date", y = "Cells/ml") +  
  facet_wrap( ~DIL)+
  geom_point( size = 1.2, colour = "darkblue", shape = 16) +
  geom_line( size = 0.5, colour = "darkblue") +
  geom_vline( xintercept = SamplDat, colour = "darkgrey", linetype = "dashed")+
  labs( title = "Lake 4", x= "date")+
  scale_y_continuous(limits=c(0, max(Bac$Cells, na.rm = T)))+
  theme_bw( )+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
This corresponds to __Figure_S4__

```{r, echo=FALSE, warning=FALSE}

Fig_S4 <- ggplot( Bac,  aes( x = DAT, y = Cells, group = Lake, colour = Lake, shape = Lake)) +
  labs(x = "date", y = "Cells/ml") +  
  facet_wrap( ~DIL)+
  geom_point( size = 1.2) +
  geom_line( size = 0.5) +
  geom_vline( xintercept = SamplDat, colour = "darkgrey", linetype = "dashed")+
  labs( title = "cell abundance over the course of the experiment", x= "", y = "Cells/ml")+
  theme_bw( )+
...
```{r, warning=FALSE}
ggsave("figures/Figure_S_4.pdf", Fig_S4, width = 8, height = 6)
```
